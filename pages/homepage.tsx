...
const homepage = () => {
  return (
    <div className="bg-black text-white h-screen relative flex">
      <div className="h-screen w-[150px] bg-black z-20 flex flex-col items-center p-8 relative">
        ...
        <div className="m-auto -rotate-90 absolute top-1/2">
      ...
      <div className="w-full flex items-center relative">
        <div className="absolute z-50 top-10 left-10 w-[104px] h-[130px] text-[#d2aa64] cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="relative z-20 m-32 space-y-8 max-w-xl flex flex-col">
          ...
          <div>
            <a
              href=""
              className="bg-[#d2aa64] text-white px-8 font-semibold py-3 transition-all transform rounded-full inline-block hover:bg-white hover:text-black text-lg"
            >
              Lorem ipsum dolor
            </a>
          </div>
