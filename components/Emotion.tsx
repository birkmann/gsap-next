...
const Emotion = () => {
  ...
  return (
    <div
      className="relative flex flex-col items-center w-full h-screen lg:flex-row"
      ref={el}
    >
      ...
      <div className="relative z-20 flex flex-col max-w-xl mx-8 my-auto space-y-8 lg:m-32">
        <h2 className="text-3xl font-semibold lg:text-6xl">
          <div className="opacity-0 animate">Lorem ipsum dolor</div>
          <div className="opacity-0 animate">sit amet consectetur</div>
        </h2>
